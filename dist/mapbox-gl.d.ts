...
type DynamicDefinesType = CircleDefinesType | SymbolDefinesType | LineDefinesType | HeatmapDefinesType | GlobeDefinesType | RasterDefinesType | RasterParticleDefinesType | FogDefinesType | HillshadeDefinesType | TerrainDepthAccessDefinesType | ModelDefinesType;
...
declare class Program$1<Us extends UniformBindings> {
	...
	fixedDefines: string[];
	static cacheKey(source: ShaderSource, name: string, defines: string[], programConfiguration?: ProgramConfiguration | null): string;
...
type QueryRenderedFeaturesOptions = Pick<QueryRenderedFeaturesParams, "layers" | "filter" | "validate">;
...
declare class Map$1 extends Camera {
	...
	queryRenderedFeatures(geometry: PointLike | [
		PointLike,
		PointLike
	], options?: QueryRenderedFeaturesOptions): Array<GeoJSONFeature>;
